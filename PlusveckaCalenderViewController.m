...
@synthesize week;
@synthesize monButton1,tueButton2,wedButton3,thrButton4,friButton5,satButton6,sunButton7,editTotalValue;
...
@synthesize totalArray,dateIndexValue,tidigeraController,forslagController,sub2Settings;
...
- (BOOL)findContact:(NSNumber*)questionId
{
    ...
    if (sqlite3_open(dbpath, &exerciseDB) == SQLITE_OK)
    {
        ...
        NSString *querySQL = [NSString stringWithFormat: @"SELECT sub2Id FROM SUB2EVENT WHERE sub2Id=\"%d\"", sub2ID];
