...
@interface TUTScatterPlot : NSObject <CPTScatterPlotDataSource> {
...
+(TUTScatterPlot *)plotWithHostingView:(CPTGraphHostingView *)hostingView andData:(NSMutableArray *)data;
