...
@interface BeteendeDateList ()

@end

@implementation BeteendeDateList
@synthesize listexercise4,tableview;
...
- (void)viewDidLoad
{
    self.navigationItem.title=@"Beteends Date List";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSLog(@"%@",SelectedDate);
    bef=[[BeteendeEditForm alloc]initWithNibName:@"BeteendeEditForm" bundle:nil];
    bef.selected_date=[[NSString alloc]init];
    bef.selected_date=SelectedDate;
    [self.navigationController pushViewController:bef
                                         animated:YES];
